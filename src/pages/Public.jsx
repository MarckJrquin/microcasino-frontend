...
import { faCoins, faChevronRight, faDiceOne, faDiceTwo, faDiceThree, faDiceFour } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 text-center">
          <h2 className="text-4xl text-center font-bold text-zinc-900 dark:text-zinc-200 leading-[3.25rem] mb-6 max-w-max lg:max-w-3xl lg:mx-auto">
            Bienvenido al Casino Online más grande del mundo mundialmente mundialisitico
          </h2>
          <p className="text-base font-normal text-zinc-500 dark:text-zinc-400 lg:max-w-2xl lg:mx-auto mb-8">
            ¡Únete al mejor casino online y gana! Disfruta de los mejores juegos de casino online y gana dinero real o juega por diversión.
          </p>  
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 lg:mb-16 flex justify-center items-center flex-col gap-x-0 gap-y-6 lg:gap-y-0 lg:flex-row lg:justify-between max-md:max-w-lg max-md:mx-auto">
            <div className="relative w-full text-center lg:text-left lg:w-2/4">
              <h2 className="text-4xl font-bold text-zinc-900 dark:text-zinc-200 leading-[3.25rem] lg:mb-6 mx-auto max-w-max lg:max-w-md lg:mx-0">
                Disfruta de los mejores juegos de casino online
              </h2>
            </div>
            <div className="relative w-full text-center  lg:text-left lg:w-2/4">
              <p className="text-lg font-normal text-zinc-500 dark:text-zinc-400 mb-5">
                Ten acceso a nuestro catalogo de juegos de casino online y gana dinero real o juega por diversión.
              </p> 
              <a href="#" className="flex flex-row items-center justify-center gap-2 text-base font-semibold text-indigo-600 lg:justify-start hover:text-indigo-700 ">
                <Button color='primary' variant='shadow' size='lg' radius='full' as={Link} href='/games' endContent={<FontAwesomeIcon icon={faChevronRight}/>}>
                  Juegos
                </Button>
              </a> 
            </div>
        </div>
        <div className="flex justify-center items-center gap-x-5 gap-y-16 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
          {gameTypes.map((game, index) => (
            <div key={index} className="group relative w-full bg-zinc-100 rounded-2xl transition-all duration-500 max-md:max-w-md max-md:mx-auto md:w-2/5 md:h-64 xl:w-1/4 hover:bg-indigo-600">
              <Card isFooterBlurred className="w-full h-[300px] col-span-12 sm:col-span-7">
                <CardHeader className="absolute z-10 top-1 flex-col items-start">
                  <p className="text-tiny text-white/60 uppercase font-bold">MICROCASINO</p>
                  <h4 className="text-white/90 font-medium text-xl">{game.name} </h4>
                </CardHeader>
                <Image
                  loading='lazy'
                  removeWrapper
                ...
                <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-600 dark:border-default-100">
                  <div className="flex flex-grow gap-2 items-center">
                    <div className="flex flex-col">
                      <p className="text-tiny text-white/60">{game.longDescription}</p>
                    </div>
                  </div>
                  <Button radius="full" size="sm" color='success' variant='shadow' as={Link} href={game.url}>Jugar</Button>
                </CardFooter>
              </Card>
            </div>
          ))}
    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 text-center">
          ...
          <h2 className="text-4xl text-center font-bold text-zinc-900 py-5">
            Revolutionary Features
          </h2>
          <p className="text-lg font-normal text-zinc-500 max-w-md md:max-w-2xl mx-auto">
        ...
        <div className="flex justify-center items-center gap-x-5 gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            ...
            <h4 className="text-lg font-medium text-zinc-900 mb-3 capitalize">
