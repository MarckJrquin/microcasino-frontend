...
const TransactionsGamesTable = ( props ) =>  {
  ...
  useEffect(() => {
    async function fetchTransactions() {
      try {
        const trasactionsData = await BillingService.getGameTransactionsHistory(userData.userId);
        setTransactions(trasactionsData);
        console.log(trasactionsData);
      } catch (error) {
        console.error("Error al recuperar transacciones de partidas o apuestas:", error);
      }
    }
...
export default TransactionsGamesTable;